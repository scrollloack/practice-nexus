...
**Context:** This should be run on the feature branch (created during brainstorming).

**Save plans to:** `docs/battle-plan/YYYY-MM-DD-<feature-name>.md`
...
Run: `bundle exec rspec spec/path/file_spec.rb --format documentation`
...
**"Plan complete and saved to `docs/battle-plan/<filename>.md`. Two execution options:**
