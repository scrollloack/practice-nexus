...
Use Agent tool with general-purpose subagent_type, fill template at `code-reviewer.md`
...
[Dispatch code-reviewer subagent using Agent tool]
  ...
  PLAN_OR_REQUIREMENTS: Task 2 from docs/battle-plan/deployment-plan.md
  BASE_SHA: a7981ec
  HEAD_SHA: 3df7661
